              ...
              <div className="relative p-8">
                <div className="mb-4 flex flex-wrap gap-2">
                  {item.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-block rounded-full bg-accent/10 px-3 py-1 text-xs font-light text-accent"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <motion.button
                  whileHover={{ x: 5 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 text-sm font-light text-accent hover:text-accent/80 transition-colors"
                >
                  View Project
                  <svg
